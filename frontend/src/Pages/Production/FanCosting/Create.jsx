...
// arithmetic: qty × unit_price × (1 + appreciation/100)
...
export default function Create({ templates, nextNumber }) {
    ...
    const inCls =
        "w-full px-2 py-1.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-400 transition-colors text-right";

    return (
        <ManufacturingLayout header="New Fan Cost Entry">
            <Head title="New Fan Cost Entry" />
